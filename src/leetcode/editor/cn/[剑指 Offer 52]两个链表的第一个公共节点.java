...
//lists/ 
// 
// Related Topics 哈希表 链表 双指针 👍 436 👎 0
...
class SolutionOffer52 {
    /**
     * 双指针交叉遍历, 如果存在交叉节点, 那么总在第一次碰到 null 之前或者之后在非 null 的地方相遇
     * 否则它们都在第二次为 null 的地方相遇
     *
     * 如果它们第一次遇到 null 是一起遇到 null, 那么肯定是两个等长不相交的链表
     *
     * 前面相等无相交：同步到 null
     * 前面相等有相交：不需要交叉, 直接到交叉点
     * 前面不等无相交：交叉，不同步到 null，然后同步到 null
     * 前面不等有相交：交叉，不同步到交叉点，不同步到 null，同步到交叉点
     */
