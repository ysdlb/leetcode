...
<ul> 
 <li>如果元素是<strong> 偶数</strong> ，<strong>除以</strong> <code>2</code> </li>
</ul>
...
<div><div>Related Topics</div><div><li>贪心</li><li>数组</li><li>有序集合</li><li>堆（优先队列）</li></div></div><br><div><li>👍 95</li><li>👎 0</li></div>